# LSTM model based on indicators and S&P500
...
class LSTM02Algorithm(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.correl_currency = "SPY"
        self.spy = self.AddEquity(self.correl_currency, Resolution.Minute)
    ...
    def OnData(self, data):
        ...
        ## low_BB and up_BB should change to the difference
